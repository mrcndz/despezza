...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['expense', 'income']> & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
}
...
export interface ApiChatChat extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    chat_type: Schema.Attribute.Enumeration<['group', 'direct']> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    description: Schema.Attribute.Text;
...
export interface ApiCreditCardCreditCard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    closing_day: Schema.Attribute.Integer &
      Schema.Attribute.Required &
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    due_day: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 31;
...
export interface ApiGroupGroup extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User groups for shared expenses';
    displayName: 'Group';
    pluralName: 'groups';
    singularName: 'group';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    group_id: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.Unique;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Chat messages with media and widgets';
    displayName: 'Message';
    pluralName: 'messages';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::message.message'> &
      Schema.Attribute.Private;
    message_type: Schema.Attribute.Enumeration<['text', 'media', 'widget', 'system']> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    read_at: Schema.Attribute.DateTime;
    referenced_transaction: Schema.Attribute.Relation<'manyToOne', 'api::transaction.transaction'>;
    replied_to: Schema.Attribute.Relation<'manyToOne', 'api::message.message'>;
    ...
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    widget_config: Schema.Attribute.Text;
    widget_type: Schema.Attribute.Enumeration<['button', 'form', 'poll', 'payment_request']>;
  };
}

export interface ApiTransactionSplitTransactionSplit extends Struct.CollectionTypeSchema {
  collectionName: 'transaction_splits';
  info: {
    description: 'Transaction splits between multiple users';
    displayName: 'Transaction Split';
    pluralName: 'transaction-splits';
    singularName: 'transaction-split';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiTransactionTransaction extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Unified table for all financial movements';
  ...
  attributes: {
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    credit_card: Schema.Attribute.Relation<'manyToOne', 'api::credit-card.credit-card'>;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    due_date: Schema.Attribute.Date & Schema.Attribute.Required;
    end_date: Schema.Attribute.Date;
    frequency: Schema.Attribute.Enumeration<['daily', 'weekly', 'monthly', 'yearly']>;
    ...
    total_amount: Schema.Attribute.Integer & Schema.Attribute.Required;
